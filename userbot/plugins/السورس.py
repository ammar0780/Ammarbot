...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/bfb8f63d200132c7d21ab.jpg"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/bfb8f63d200132c7d21ab.jpg"
...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or " Future Source 𓃠"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/bfb8f63d200132c7d21ab.jpg"
...
.𓄌 : ping  {ping}  𓇡.
.𓄌 : version 7.5  𓇡.
.𓄌 : Source Future : @FFDUA  𓇡."""
@iqthon.on(admin_cmd(pattern="رابط التنصيب(?: |$)(.*)"))    
async def source(e):
    await edit_or_reply(e, "https://t.me/FFDUA",)
...
async def _(event):
    ...
    OUTPUT = (f"♛︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس مستقبل @iqthon :**\n\n{o}")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://t.me/FFDUA"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://t.me/FFDUA"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://t.me/FFDUA"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/LLL5L"),]]
...
async def iq(event):
    await edit_or_reply(event, """✐  ⦗ اوامـر سـورس  العـرب ⦘
                                             ┉┉┉┉┉┉×┉┉┉┉┉
〖`.م1`〗⏎  اوامر الحساب 1
〖`.م2`〗⏎  اوامر الحساب 2
〖`.م3`〗⏎  اوامر الحساب 3
